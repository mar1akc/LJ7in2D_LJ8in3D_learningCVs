...
// Compile command:  gcc -Wall LJ7_WTMetad_MargotCV_2D.c MargotColVar_CoordNum.c timestep_helpers.c -lm -O3
...
// 	printf("LJpot + restraining pot = %.4e\n",*pot);
...
// 			printf("step %i, Vpot0 = %.4e,CVval = [%.4e,%.4e]\n",n,*Vpot0,CVval[0],CVval[1]);
