...
// If BETA == 7 or 9, include CommittorRC_ReLU4.h

// Compile command:  gcc -Wall FFS.c CommittorRC_ReLU4.c CV_helpers.c timestep_helpers.c -lm -O3
...
double exit_flux(double *init_conf,double *exit_conf,struct NNRC *nnrc,
				 double dt,double *milestones, int Nmilestones);
double prob_next_milestone(double *init_conf,double *exit_conf,struct NNRC *nnrc,
...
// 	int run_id = 1;
	...
	conf0 = (double *)malloc(dim*sizeof(double));
	CV = (double *)malloc((nnrc->dim0)*sizeof(double));
