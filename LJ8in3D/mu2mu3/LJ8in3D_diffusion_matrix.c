...
// Compile command:  gcc -Wall LJ8in3D_diffusion_matrix.c CV_helpers.c timestep_helpers.c -lm -O3
...
void total_pot_and_grad(double *conf,int Natoms,double *pot,double *grad,
	double *CV,double *CVgrad,double CV1star,double CV2star,double Bkappa);
