...
for j = 1 : 8
    ...
    A_dash(j,abs(d-LJrad)<tol_dash) = 1;
end
N = 8;
...
if flag == 1
    ...
    Nbonds = length(ii);
     ...
     ind_dash = find(A_dash == 1);
    [I1 J1] = ind2sub([N,N],ind_dash);
    ii1 = find(I1 > J1);
    [I1 J1] = ind2sub([N,N],ind_dash(ii1));
    Nbonds_dash = length(ii1);
    ...
    for i = 1 : Nbonds_dash
        ...
        x1 = x(:,J1(i));
        xx = [x0,x1];
c        plot3(xx(1,:),xx(2,:),xx(3,:),'k--','LineWidth',2);
    end
