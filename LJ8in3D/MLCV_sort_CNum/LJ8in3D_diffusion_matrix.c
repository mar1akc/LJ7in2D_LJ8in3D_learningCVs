...
// Compile command:  gcc -Wall LJ8in3D_diffusion_matrix.c timestep_helpers.c MargotColVar_CoordNum.c -lm -O3
...
// 	CV2grad = (double *)malloc(dim*sizeof(double));
	...
	cvgrad = (double *)malloc((nncv->dim4)*dim*sizeof(double));
	cvval = (double *)malloc((nncv->dim4)*sizeof(double));
