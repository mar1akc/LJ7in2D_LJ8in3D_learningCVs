...
BETA = 10;
dir = sprintf("FEMdataBETA%d/Committor_min01_LDA23_BETA%d/",BETA,BETA);

NN = 25;
fname_A1 = strcat(dir,'linear1_weight_[',num2str(NN),',2].csv');  
fname_b1 = strcat(dir,'linear1_bias_[',num2str(NN),'].csv');  

fname_A2 = strcat(dir,'linear2_weight_[',num2str(NN),',',num2str(NN),'].csv');  
fname_b2 = strcat(dir,'linear2_bias_[',num2str(NN),'].csv');  

fname_A3 = strcat(dir,'linear3_weight_[',num2str(NN),',',num2str(NN),'].csv');  
fname_b3 = strcat(dir,'linear3_bias_[',num2str(NN),'].csv');  

fname_A4 = strcat(dir,'linear4_weight_[1,',num2str(NN),'].csv'); 
